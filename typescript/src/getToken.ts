...
async function main() {
  try {
    ...
    if (!process.env.USERNAME || !process.env.PASSWORD) {
      throw new Error('USERNAME and PASSWORD must be set in a .env file in the typescript directory. You can rename .env.sample to .env and fill in your own email and password.');
    }
