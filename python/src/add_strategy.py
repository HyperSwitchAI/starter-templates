...
def main():
    try:
        ...
        response = requests.post(
            f'{BASE_URL}/admin/strategies/add-strategy',
            headers={
        ...
        if not response.ok:
            ...
            raise requests.exceptions.HTTPError(f'Failed to add strategy: {response.reason}')

        print('\n\033[92m✅ Strategy added successfully\033[0m')
