...
public class UpdateStrategy {
    ...
    public static void main(String[] args) {
        try {
            ...
            strategyPayload.put("model", "claude-3-5-haiku-20241022");
            strategyPayload.put("keyId", "claude-key-1");
            strategyPayload.put("provider", "anthropic");

            HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create(BASE_URL + "/admin/strategies/update-strategy"))
            ...
            if (response.statusCode() != 200) {
                ...
                throw new RuntimeException("Failed to update strategy: " + response.body());
            }

            System.out.println("\u001B[32m✅ Strategy updated successfully\u001B[0m");
