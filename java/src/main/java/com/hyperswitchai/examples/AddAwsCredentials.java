...
public class AddAwsCredentials {
    ...
    public static void main(String[] args) {
        try {
            ...
            keyPayload.put("keyId", "bedrock-key-1");
            keyPayload.put("encryptionFragment", "OpenThePodBayDoorsHAL-2001");
            keyPayload.put("provider", "bedrock");
            keyPayload.put("accessKeyId", "AKIDFGRTHTHYTHTY");
            keyPayload.put("secretAccessKey", "ehegruherghekjllkdfjhgkjdfh");
